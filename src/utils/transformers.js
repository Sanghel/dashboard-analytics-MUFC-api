...
const transformFixture = (f, season, leagueId) => ({
  id: f.fixture.id,
...
const transformFixtureStat = (stat, teamId, teamName) => ({
  team_id: teamId,
  team_name: teamName,
  stat_type: stat.type,
...
const transformStanding = (s, season, leagueId) => ({
  season,
  league_id: leagueId,
  team_id: s.team.id,
...
const transformTeamStats = (s, season, leagueId, teamId) => ({
  season,
  league_id: leagueId,
  team_id: teamId,
  form: s.form || null,
